...
/**
 * Created by techresult on 03/02/2016.
 */
...
public class SegmentedGroup extends RadioGroup {
    ...
    public SegmentedGroup(Context context, AttributeSet attrs, int tabControlButtonStyle) {
        super(context);
    ...
    private void updateBackground(View view) {
        ...
        //<<DM
        ((GradientDrawable) uncheckedDrawable).setStroke(mMarginDp, Color.GRAY);
        //DM>>
        //Set proper radius
