...
import br.gov.sp.educacao.sed.mobile.AvaliacaoLancamentoActivity;
 ...
 */
public class FragmentTabAvaliacaoLancamento extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lvValor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getActivity(), AvaliacaoLancamentoActivity.class);
                intent.putExtra(TurmaGrupo.BUNDLE_TURMA_GRUPO, turmaArrayList.get(i));
